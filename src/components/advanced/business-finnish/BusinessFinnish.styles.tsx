...
export const ExampleFinnish = styled.div`
  font-size: 1.125rem;
  font-weight: 600;
  color: #1d4ed8;
  margin-bottom: 0.5rem;
...
export const ExampleTranslation = styled.div`
  font-style: italic;
  color: #6b7280;
  margin-bottom: 0.5rem;
  font-size: 0.9rem;
...
export const TableCell = styled.td<{ $emphasis?: boolean }>`
  ...
  vertical-align: top;
  font-weight: ${(props) => (props.$emphasis ? "600" : "normal")};
  color: ${(props) => (props.$emphasis ? "#1d4ed8" : "#374151")};
`;
