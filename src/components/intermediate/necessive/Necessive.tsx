    ...
    <Container>
      <ExplanationSection>
        ...
        <FunFactBox>
          ...
          The necessive form is sometimes called the &quot;fourth infinitive&quot; in traditional Finnish grammar, though it functions more like a participle in modern usage!
        </FunFactBox>
        ...
        <CaseUsageContainer>
          <UsageItem>
            ...
            <ExampleBox>
              <ExampleText>Tämä kirja on luettava → This book must be read</ExampleText>
              <ExampleText>Läksyt on tehtävä → The homework must be done</ExampleText>
              <ExampleText>Ruoka on syötävä → The food must be eaten</ExampleText>
            </ExampleBox>
          </UsageItem>
          ...
          <UsageItem>
            ...
            <ExampleBox>
              <ExampleText>Tämä elokuva on katottava → This movie must be seen</ExampleText>
              <ExampleText>Suomi on käytävä → Finland must be visited</ExampleText>
              <ExampleText>Tämä ravintola on kokeiltava → This restaurant must be tried</ExampleText>
            </ExampleBox>
          </UsageItem>
          ...
          <UsageItem>
            ...
            <ExampleBox>
              <ExampleText>Hakemus on täytettävä → The application must be filled</ExampleText>
              <ExampleText>Lääkkeet on otettava → The medicine must be taken</ExampleText>
              <ExampleText>Auton on käynnistyttävä → The car must be started</ExampleText>
            </ExampleBox>
          </UsageItem>

          <UsageItem>
            <KeyPoint>4. Creating nouns meaning &quot;something to be...&quot;</KeyPoint>
            <ExampleBox>
              <ExampleText>tehtävä → task (something to be done)</ExampleText>
              <ExampleText>luettava → reading material (something to be read)</ExampleText>
              <ExampleText>syötävä → food (something to be eaten)</ExampleText>
              <ExampleText>juotava → beverage (something to be drunk)</ExampleText>
            </ExampleBox>
          </UsageItem>
        </CaseUsageContainer>
        ...
        <ExplanationContent>
          The necessive form is often used with the verb &quot;olla&quot; (to be) and personal pronouns to indicate who must do something:
        </ExplanationContent>
        ...
        <NegativeFormationSection>
          <KeyPoint>Rule: Use <Highlight>ei tarvitse</Highlight> + first infinitive for &quot;don&apos;t need to&quot;</KeyPoint>
          ...
          <FormationTable>
            ...
            <tbody>
              <FormationTableRow>
                ...
                <FormationTableCell>I don&apos;t need to read</FormationTableCell>
              </FormationTableRow>
              <FormationTableRow>
                <FormationTableCell>Sinun on tehtävä</FormationTableCell>
                <FormationTableCell>Sinun ei tarvitse tehdä</FormationTableCell>
                <FormationTableCell>You don&apos;t need to do</FormationTableCell>
              </FormationTableRow>
              <FormationTableRow>
                <FormationTableCell>Hänen on mentävä</FormationTableCell>
                <FormationTableCell>Hänen ei tarvitse mennä</FormationTableCell>
                <FormationTableCell>He don&apos;t need to go</FormationTableCell>
              </FormationTableRow>
            </tbody>
          </FormationTable>
          
          <KeyPoint>Rule: Use <Highlight>ei saa</Highlight> + first infinitive for &quot;must not&quot;</KeyPoint>
          
          <NegativeExample>
            <ExampleText>Sinun ei saa tupakoida täällä → You must not smoke here</ExampleText>
            <ExampleText>Meidän ei saa myöhästyä → We must not be late</ExampleText>
            <ExampleText>Heidän ei saa unohtaa → They must not forget</ExampleText>
          </NegativeExample>
        </NegativeFormationSection>
        ...
        <ExampleBox>
          <ExampleText>1. Minun on opiskeltava suomea → I must study Finnish</ExampleText>
          <ExampleText>2. Tämä lääke on otettava aterian kanssa → This medicine must be taken with a meal</ExampleText>
          <ExampleText>3. Sinun on soitettava äidillesi → You must call your mother</ExampleText>
          <ExampleText>4. Tämä nähtävyys on nähtävä → This sight must be seen</ExampleText>
          <ExampleText>5. Meidän on matkustettava huomenna → We must travel tomorrow</ExampleText>
          <ExampleText>6. Lapset on nukutettava ennen kymmentä → The children must be put to bed before ten</ExampleText>
          <ExampleText>7. Teidän on täytettävä lomake → You must fill out the form</ExampleText>
          <ExampleText>8. Hänen on harjoiteltava enemmän → He must practice more</ExampleText>
        </ExampleBox>
        ...
        <FormationTable>
          ...
          <tbody>
            <FormationTableRow>
              ...
              <FormationTableCell>Minun on pakko mennä → I absolutely must go</FormationTableCell>
            </FormationTableRow>
            <FormationTableRow>
              <FormationTableCell>On mentävä</FormationTableCell>
              <FormationTableCell>Must go</FormationTableCell>
              <FormationTableCell>Nyt on mentävä → Now we must go</FormationTableCell>
            </FormationTableRow>
            <FormationTableRow>
              <FormationTableCell>On tehtävä</FormationTableCell>
              <FormationTableCell>Must do</FormationTableCell>
              <FormationTableCell>Se on tehtävä → It must be done</FormationTableCell>
            </FormationTableRow>
            <FormationTableRow>
              <FormationTableCell>On otettava</FormationTableCell>
              <FormationTableCell>Must take</FormationTableCell>
              <FormationTableCell>Riski on otettava → The risk must be taken</FormationTableCell>
            </FormationTableRow>
          </tbody>
        </FormationTable>
        ...
        <SummaryBox>
          ...
          <ExplanationContent>
            ✅ Form it by adding -tava/-tävä to the verb stem (with variations by verb type)
          </ExplanationContent>
          <ExplanationContent>
            ✅ Use with &quot;minun on&quot;, &quot;sinun on&quot;, etc. to specify who must do something
          </ExplanationContent>
          <ExplanationContent>
            ✅ Use &quot;ei tarvitse&quot; for &quot;don&apos;t need to&quot; and &quot;ei saa&quot; for &quot;must not&quot;
          </ExplanationContent>
          <ExplanationContent>
            ✅ Many common nouns are derived from necessive forms (tehtävä, luettava, etc.)
          </ExplanationContent>
          <ExplanationContent>
        ...
        <FunFactBox>
          <span>🌟 Pro Tip: </span>
          When you hear Finns say something &quot;on pakko&quot; (is must) or &quot;on pakko tehdä&quot; (must do), they&apos;re using a colloquial variant of the necessive construction that emphasizes strong obligation!
        </FunFactBox>
      </ExplanationSection>
    </Container>
  );
