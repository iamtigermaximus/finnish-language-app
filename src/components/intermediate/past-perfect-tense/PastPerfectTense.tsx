...
const verbTypes: VerbType[] = [
  {
    ...
    pattern: "Form the past participle by removing the final vowel and adding -nut/nyt. Then combine with the past tense of olla.",
    negativePattern: "Use the negative past form of olla + the past participle (nut/nyt for singular, neet for plural).",
    conjugation: {
      puhua: {
        positive: ["Minä olin puhunut", "Sinä olit puhunut", "Hän oli puhunut", "Me olimme puhuneet", "Te olitte puhuneet", "He olivat puhuneet"],
        negative: ["Minä en ollut puhunut", "Sinä et ollut puhunut", "Hän ei ollut puhunut", "Me emme olleet puhuneet", "Te ette olleet puhuneet", "He eivät olleet puhuneet"]
      },
      lukea: {
        positive: ["Minä olin lukenut", "Sinä olit lukenut", "Hän oli lukenut", "Me olimme lukeneet", "Te olitte lukeneet", "He olivat lukeneet"],
        negative: ["Minä en ollut lukenut", "Sinä et ollut lukenut", "Hän ei ollut lukenut", "Me emme olleet lukeneet", "Te ette olleet lukeneet", "He eivät olleet lukeneet"]
      }
    }
  },
  {
    ...
    pattern: "Form the past participle by removing -da/-dä and adding -nut/nyt. Then combine with the past tense of olla.",
    negativePattern: "Use the negative past form of olla + the past participle (nut/nyt for singular, neet for plural).",
    conjugation: {
      syödä: {
        positive: ["Minä olin syönyt", "Sinä olit syönyt", "Hän oli syönyt", "Me olimme syöneet", "Te olitte syöneet", "He olivat syöneet"],
        negative: ["Minä en ollut syönyt", "Sinä et ollut syönyt", "Hän ei ollut syönyt", "Me emme olleet syöneet", "Te ette olleet syöneet", "He eivät olleet syöneet"]
      },
      juoda: {
        positive: ["Minä olin juonut", "Sinä olit juonut", "Hän oli juonut", "Me olimme juoneet", "Te olitte juoneet", "He olivat juoneet"],
        negative: ["Minä en ollut juonut", "Sinä et ollut juonut", "Hän ei ollut juonut", "Me emme olleet juoneet", "Te ette olleet juoneet", "He eivät olleet juoneet"]
      }
    }
  },
  {
    ...
    pattern: "Form the past participle by removing the last two letters and adding -lut/lyt or -nut/nyt. Then combine with the past tense of olla.",
    negativePattern: "Use the negative past form of olla + the past participle (lut/lyt or nut/nyt for singular, leet or neet for plural).",
    conjugation: {
      tulla: {
        positive: ["Minä olin tullut", "Sinä olit tullut", "Hän oli tullut", "Me olimme tulleet", "Te olitte tulleet", "He olivat tulleet"],
        negative: ["Minä en ollut tullut", "Sinä et ollut tullut", "Hän ei ollut tullut", "Me emme olleet tulleet", "Te ette olleet tulleet", "He eivät olleet tulleet"]
      },
      mennä: {
        positive: ["Minä olin mennyt", "Sinä olit mennyt", "Hän oli mennyt", "Me olimme menneet", "Te olitte menneet", "He olivat menneet"],
        negative: ["Minä en ollut mennyt", "Sinä et ollut mennyt", "Hän ei ollut mennyt", "Me emme olleet menneet", "Te ette olleet menneet", "He eivät olleet menneet"]
      }
    }
  },
  {
    ...
    pattern: "Form the past participle by removing -ta/-tä and adding -nnut/nnyt. Then combine with the past tense of olla.",
    negativePattern: "Use the negative past form of olla + the past participle (nnut/nnyt for singular, nneet for plural).",
    conjugation: {
      tavata: {
        positive: ["Minä olin tavannut", "Sinä olit tavannut", "Hän oli tavannut", "Me olimme tavanneet", "Te olitte tavanneet", "He olivat tavanneet"],
        negative: ["Minä en ollut tavannut", "Sinä et ollut tavannut", "Hän ei ollut tavannut", "Me emme olleet tavanneet", "Te ette olleet tavanneet", "He eivät olleet tavanneet"]
      },
      haluta: {
        positive: ["Minä olin halunnut", "Sinä olit halunnut", "Hän oli halunnut", "Me olimme halunneet", "Te olitte halunneet", "He olivat halunneet"],
        negative: ["Minä en ollut halunnut", "Sinä et ollut halunnut", "Hän ei ollut halunnut", "Me emme olleet halunneet", "Te ette olleet halunneet", "He eivät olleet halunneet"]
      }
    }
  },
  {
    ...
    conjugation: {
      tarvita: {
        positive: ["Minä olin tarvinnut", "Sinä olit tarvinnut", "Hän oli tarvinnut", "Me olimme tarvinneet", "Te olitte tarvinneet", "He olivat tarvinneet"],
        negative: ["Minä en ollut tarvinnut", "Sinä et ollut tarvinnut", "Hän ei ollut tarvinnut", "Me emme olleet tarvinneet", "Te ette olleet tarvinneet", "He eivät olleet tarvinneet"]
      },
      valita: {
        positive: ["Minä olin valinnut", "Sinä olit valinnut", "Hän oli valinnut", "Me olimme valinneet", "Te olitte valinneet", "He olivat valinneet"],
        negative: ["Minä en ollut valinnut", "Sinä et ollut valinnut", "Hän ei ollut valinnut", "Me emme olleet valinneet", "Te ette olleet valinneet", "He eivät olleet valinneet"]
      }
    }
  },
  {
    ...
    conjugation: {
      paeta: {
        positive: ["Minä olin paennut", "Sinä olit paennut", "Hän oli paennut", "Me olimme pakenneet", "Te olitte pakenneet", "He olivat pakenneet"],
        negative: ["Minä en ollut paennut", "Sinä et ollut paennut", "Hän ei ollut paennut", "Me emme olleet pakenneet", "Te ette olleet pakenneet", "He eivät olleet pakenneet"]
      },
      vanheta: {
        positive: ["Minä olin vanhennut", "Sinä olit vanhennut", "Hän oli vanhennut", "Me olimme vanhenneet", "Te olitte vanhenneet", "He olivat vanhenneet"],
        negative: ["Minä en ollut vanhennut", "Sinä et ollut vanhennut", "Hän ei ollut vanhennut", "Me emme olleet vanhenneet", "Te ette olleet vanhenneet", "He eivät olleet vanhenneet"]
      }
    }
  }
];
...
const PastPerfectTense = () => {
  ...
  return (
    <Container>
      <h2>Finnish Verb Types - Past Perfect Tense</h2>
      
      <div style={{ padding: '15px', backgroundColor: '#f0f9ff', borderRadius: '8px', marginBottom: '20px' }}>
        <p>
          The past perfect tense in Finnish (pluskvamperfekti) is formed with the past tense of the auxiliary verb &quot;olla&quot; (to be) 
          combined with the past participle (nut/nyt/neet) of the main verb. It describes actions that were completed before another past action.
        </p>
      </div>
      ...
      <div style={{ 
        ...
        <h3>Remember This!</h3>
        <p>
          The past perfect tense is formed with the past tense of &quot;olla&quot; (to be) + the past participle.
          It describes actions that were completed before another past action or time in the past.
        </p>
        <p style={{ marginTop: '10px', fontWeight: 'bold' }}>
          For the negative past perfect tense, use the negative past form of &quot;olla&quot; (en ollut, et ollut, ei ollut, etc.) 
          + the appropriate participle form (nut/nyt for singular, neet for plural).
        </p>
        <p style={{ marginTop: '10px', fontStyle: 'italic' }}>
          Example: &quot;Minä olin jo syönyt, kun sinä tulit&quot; (I had already eaten when you came)
        </p>
      </div>
    </Container>
  );
