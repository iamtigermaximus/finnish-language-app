...
const Partitive = () => {
  return (
    <Container>
      <ExplanationSection>
        <Title>Finnish Partitive Case </Title>

        <ExplanationContent>
          The partitive case is one of the most important and frequently used
          cases in Finnish. It indicates partiality, incompleteness, or
          unspecified quantity. While it might seem challenging at first,
          you&apos;ll find it follows consistent patterns that become intuitive
          with practice.
        </ExplanationContent>

        <FunFactBox>
          <span>Did you know? </span>
          The partitive case is used so frequently in Finnish that it accounts
          for about 15-20% of all noun case usage in typical conversation!
        </FunFactBox>
        ...
        <CaseUsageContainer>
          <UsageItem>
            ...
            <ExampleBox>
              ...
              <ExampleText>
                Haluatko kahvia? → Would you like (some) coffee?
              </ExampleText>
              <ExampleText>
                Luen kirjaa → I&apos;m reading a book (part of it)
              </ExampleText>
            </ExampleBox>
          </UsageItem>
        ...
        <ExplanationTitle>
          Partitive with Numbers and Quantifiers
        </ExplanationTitle>
        ...
        <ExampleBox>
          <ExampleText>
            Note: With the number &quot;yksi&quot; (one), use the nominative:
            yksi talo (one house)
          </ExampleText>
        </ExampleBox>
        ...
        <NegativeFormationSection>
          <KeyPoint>
            Rule: Objects in negative sentences typically take the partitive
            case
          </KeyPoint>
        ...
        <ExampleBox>
          <ExampleText>
            1. Ostin kahvia ja leipää → I bought coffee and bread
          </ExampleText>
          <ExampleText>
            2. Luen hyvää kirjaa → I&apos;m reading a good book
          </ExampleText>
          <ExampleText>
            3. Hänellä on kahta lasta → He has two children
          </ExampleText>
          <ExampleText>
            4. Rakastan suomalaista musiikkia → I love Finnish music
          </ExampleText>
          <ExampleText>5. En juo maitoa → I don&apos;t drink milk</ExampleText>
          <ExampleText>
            6. Puhutko englantia? → Do you speak English?
          </ExampleText>
          <ExampleText>
            7. Tarviramme lisää aikaa → We need more time
          </ExampleText>
          <ExampleText>
            8. Kaksi ihmistä odottaa bussia → Two people are waiting for the bus
          </ExampleText>
        </ExampleBox>
        ...
        <SummaryBox>
          ...
          <ExplanationContent>
            ✅ Use partitive for partial/unspecified quantities (some water, two
            books)
          </ExplanationContent>
          <ExplanationContent>
          ...
          <ExplanationContent>
            ✅ Remember that practice makes perfect - you&apos;ll internalize
            these rules with time!
          </ExplanationContent>
        </SummaryBox>

        <FunFactBox>
          <span>🌟 Pro Tip: </span>
          When in doubt, ask yourself: &quot;Am I referring to a specific,
          complete thing or an unspecified/partial amount?&quot; This will often
          guide you to the correct case choice.
        </FunFactBox>
      </ExplanationSection>
    </Container>
  );
