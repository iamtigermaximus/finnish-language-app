...
const verbTypes: VerbType[] = [
  {
    ...
    pattern: "Remove the final vowel and add -i- before adding personal endings. Consonant gradation often occurs.",
    negativePattern: "Use the stem without the final vowel + -nut/nyt (singular) or -neet (plural) with the negative verb.",
    conjugation: {
      puhua: {
        positive: ["Minä puhuin", "Sinä puhuit", "Hän puhui", "Me puhuimme", "Te puhuitte", "He puhuivat"],
        negative: ["Minä en puhunut", "Sinä et puhunut", "Hän ei puhunut", "Me emme puhuneet", "Te ette puhuneet", "He eivät puhuneet"]
      },
      lukea: {
        positive: ["Minä luin", "Sinä luit", "Hän luki", "Me luimme", "Te luitte", "He lukivat"],
        negative: ["Minä en lukenut", "Sinä et lukenut", "Hän ei lukenut", "Me emme lukeneet", "Te ette lukeneet", "He eivät lukeneet"]
      }
    }
  },
  {
    ...
    pattern: "Remove -da/-dä and add -si- before personal endings. No consonant gradation occurs.",
    negativePattern: "Use the stem (without -da/-dä) + -nut/nyt (singular) or -neet (plural) with the negative verb.",
    conjugation: {
      syödä: {
        positive: ["Minä söin", "Sinä söit", "Hän söi", "Me söimme", "Te söitte", "He söivät"],
        negative: ["Minä en syönyt", "Sinä et syönyt", "Hän ei syönyt", "Me emme syöneet", "Te ette syöneet", "He eivät syöneet"]
      },
      juoda: {
        positive: ["Minä join", "Sinä joit", "Hän joi", "Me joimme", "Te joitte", "He joivat"],
        negative: ["Minä en juonut", "Sinä et juonut", "Hän ei juonut", "Me emme juoneet", "Te ette juoneet", "He eivät juoneet"]
      }
    }
  },
  {
    ...
    pattern: "Remove the last two letters and add -i- before personal endings. Consonant gradation may occur.",
    negativePattern: "Use the stem (without the last two letters) + -lut/lyt (singular) or -leet (plural) with the negative verb.",
    conjugation: {
      tulla: {
        positive: ["Minä tulin", "Sinä tulit", "Hän tuli", "Me tulimme", "Te tulitte", "He tulivat"],
        negative: ["Minä en tullut", "Sinä et tullut", "Hän ei tullut", "Me emme tulleet", "Te ette tulleet", "He eivät tulleet"]
      },
      mennä: {
        positive: ["Minä menin", "Sinä menit", "Hän meni", "Me menimme", "Te menitte", "He menivät"],
        negative: ["Minä en mennyt", "Sinä et mennyt", "Hän ei mennyt", "Me emme menneet", "Te ette menneet", "He eivät menneet"]
      }
    }
  },
  {
    ...
    pattern: "Remove -ta/-tä and add -si- before personal endings. Consonant gradation often occurs.",
    negativePattern: "Use the stem (without -ta/-tä) + -nnut/nnyt (singular) or -nneet (plural) with the negative verb.",
    conjugation: {
      tavata: {
        positive: ["Minä tapasin", "Sinä tapasit", "Hän tapasi", "Me tapasimme", "Te tapasitte", "He tapasivat"],
        negative: ["Minä en tavannut", "Sinä et tavannut", "Hän ei tavannut", "Me emme tavanneet", "Te ette tavanneet", "He eivät tavanneet"]
      },
      haluta: {
        positive: ["Minä halusin", "Sinä halusit", "Hän halusi", "Me halusimme", "Te halusitte", "He halusivat"],
        negative: ["Minä en halunnut", "Sinä et halunnut", "Hän ei halunnut", "Me emme halunneet", "Te ette halunneet", "He eivät halunneet"]
      }
    }
  },
  {
    ...
    conjugation: {
      tarvita: {
        positive: ["Minä tarvitsin", "Sinä tarvitsit", "Hän tarvitsi", "Me tarvitsimme", "Te tarvitsitte", "He tarvitsivat"],
        negative: ["Minä en tarvinnut", "Sinä et tarvinnut", "Hän ei tarvinnut", "Me emme tarvinneet", "Te ette tarvinneet", "He eivät tarvinneet"]
      },
      valita: {
        positive: ["Minä valitsin", "Sinä valitsit", "Hän valitsi", "Me valitsimme", "Te valitsitte", "He valitsivat"],
        negative: ["Minä en valinnut", "Sinä et valinnut", "Hän ei valinnut", "Me emme valinneet", "Te ette valinneet", "He eivät valinneet"]
      }
    }
  },
  {
    ...
    conjugation: {
      paeta: {
        positive: ["Minä pakenin", "Sinä pakenit", "Hän pakeni", "Me pakenimme", "Te pakenitte", "He pakenivat"],
        negative: ["Minä en paennut", "Sinä et paennut", "Hän ei paennut", "Me emme pakenneet", "Te ette pakenneet", "He eivät pakenneet"]
      },
      vanheta: {
        positive: ["Minä vanhenin", "Sinä vanhenit", "Hän vanheni", "Me vanhenimme", "Te vanhenitte", "He vanhenivat"],
        negative: ["Minä en vanhennut", "Sinä et vanhennut", "Hän ei vanhennut", "Me emme vanhenneet", "Te ette vanhenneet", "He eivät vanhenneet"]
      }
    }
  }
];
...
const PastTense = () => {
  ...
  return (
    <Container>
      <h2>Finnish Verb Types - Past Tense</h2>
      
      <div style={{ padding: '15px', backgroundColor: '#f0f9ff', borderRadius: '8px', marginBottom: '20px' }}>
        <p>
          Finnish verbs are divided into six types based on their endings and how they conjugate in the past tense. 
          Each type follows specific patterns that help you conjugate them correctly.
        </p>
      </div>
      ...
      <div style={{ 
        ...
        <h3>Remember This!</h3>
        <p>
          Each verb type follows specific patterns in the past tense. With practice, you&apos;ll recognize these patterns 
          and conjugate Finnish verbs correctly!
        </p>
        <p style={{ marginTop: '10px', fontWeight: 'bold' }}>
          For negative past tense, remember to use the correct participle form (nut/nyt for singular, neet for plural) 
          with the negative verb (en, et, ei, emme, ette, eivät).
        </p>
      </div>
    </Container>
  );
