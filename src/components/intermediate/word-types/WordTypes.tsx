...
const WordTypes = () => {
  return (
    <Container>
      <ExplanationSection>
        <Title>Finnish Word Types</Title>

        <ExplanationContent>
          Finnish words can be categorized into types based on their structure,
          endings, and how they behave in sentences. Understanding these
          patterns will help you predict how words change in different cases and
          make learning Finnish grammar much easier!
        </ExplanationContent>

        <FunFactBox>
          <span>Did you know? </span>
          Finnish has a remarkable regularity in its word formation. Once you
          learn the patterns for a word type, you can apply them to most words
          in that category!
        </FunFactBox>
        ...
        <TwoColumnLayout>
              ...
              <FormationTable>
                ...
                <tbody>
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      talo<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      talo<Highlight>a</Highlight>
                    </FormationTableCell>
                  ...
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      kirja<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      kirja<Highlight>a</Highlight>
                    </FormationTableCell>
                  ...
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      lattia<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      lattia<Highlight>a</Highlight>
                    </FormationTableCell>
              ...
              <FormationTable>
                ...
                <tbody>
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      käde<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      kätt<Highlight>ä</Highlight>
                    </FormationTableCell>
                  ...
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      naise<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      naist<Highlight>a</Highlight>
                    </FormationTableCell>
                  ...
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      viera<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      vierast<Highlight>a</Highlight>
                    </FormationTableCell>
          ...
          <Column>
            <WordTypeContainer>
              ...
              <KeyPoint>
                Stem changes in inflection, often end in -si, -ni, -ri
              </KeyPoint>
              ...
              <FormationTable>
                ...
                <tbody>
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      vede<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      vett<Highlight>ä</Highlight>
                    </FormationTableCell>
                  ...
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      kude<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      kutt<Highlight>a</Highlight>
                    </FormationTableCell>
                  ...
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      tule<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      tult<Highlight>a</Highlight>
                    </FormationTableCell>
              ...
              <FormationTable>
                ...
                <tbody>
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      auto<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      auto<Highlight>a</Highlight>
                    </FormationTableCell>
                  ...
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      banaani<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      banaani<Highlight>a</Highlight>
                    </FormationTableCell>
                  ...
                  <FormationTableRow>
                    ...
                    <FormationTableCell>
                      televisio<Highlight>n</Highlight>
                    </FormationTableCell>
                    <FormationTableCell>
                      televisio<Highlight>a</Highlight>
                    </FormationTableCell>
        ...
        <ExplanationTitle>
          Verb Types (Based on Inflection Patterns)
        </ExplanationTitle>
        ...
        <FormationTable>
          ...
          <tbody>
            <FormationTableRow>
              ...
              <FormationTableCell>
                End in -aa/-ää, -ua/-yä, -oa/-öä, -ia/-iä
              </FormationTableCell>
              <FormationTableCell>
                puhua, lukea, odottaa, antaa
              </FormationTableCell>
            </FormationTableRow>
            <FormationTableRow>
              ...
              <FormationTableCell>
                syödä, juoda, tehdä, nähdä
              </FormationTableCell>
            </FormationTableRow>
            <FormationTableRow>
              <FormationTableCell>Type 3</FormationTableCell>
              <FormationTableCell>
                End in -lla/-llä, -nna/-nnä, -rra/-rrä, -sta/-stä
              </FormationTableCell>
              <FormationTableCell>
                tulla, mennä, purra, nousta
              </FormationTableCell>
            </FormationTableRow>
            <FormationTableRow>
              <FormationTableCell>Type 4</FormationTableCell>
              <FormationTableCell>
                End in -ata/-ätä, -ota/-ötä, -uta/-ytä
              </FormationTableCell>
              <FormationTableCell>
                tavata, haluta, tarjota, pelätä
              </FormationTableCell>
            </FormationTableRow>
            <FormationTableRow>
              ...
              <FormationTableCell>
                tarvita, valita, mainita, hävittää
              </FormationTableCell>
            </FormationTableRow>
            <FormationTableRow>
        ...
        <ColorCodedExample>
          <div>
            <Highlight>Type 1 Noun:</Highlight> Ostin uuden{" "}
            <Highlight>talo</Highlight>
            <Highlight>n</Highlight>. → I bought a new house.
          </div>
          <div>
            <Highlight>Type 2 Noun:</Highlight> Hän otti{" "}
            <Highlight>käde</Highlight>
            <Highlight>n</Highlight> esiin. → He took out his hand.
          </div>
          <div>
            <Highlight>Type 3 Noun:</Highlight> Juon <Highlight>vett</Highlight>
            <Highlight>ä</Highlight>. → I drink water.
          </div>
          <div>
            <Highlight>Type 1 Verb:</Highlight> <Highlight>Puhu</Highlight>
            <Highlight>n</Highlight> suomea. → I speak Finnish.
          </div>
          <div>
            <Highlight>Type 2 Verb:</Highlight> <Highlight>Syö</Highlight>
            <Highlight>n</Highlight> omenan. → I eat an apple.
          </div>
          <div>
            <Highlight>Type 3 Verb:</Highlight> <Highlight>Tule</Highlight>
            <Highlight>n</Highlight> huomenna. → I will come tomorrow.
          </div>
        </ColorCodedExample>

        <ExplanationTitle>
          Recognizing Word Types by Ending Patterns
        </ExplanationTitle>
        ...
        <ExampleBox>
          <ExampleText>
            <Highlight>Type 1 Noun:</Highlight> talo (nom) → talo
            <Highlight>n</Highlight> (gen) → talo<Highlight>a</Highlight> (part)
            → talo<Highlight>ssa</Highlight> (iness)
          </ExampleText>
          <ExampleText>
            <Highlight>Type 2 Noun:</Highlight> käsi (nom) → käde
            <Highlight>n</Highlight> (gen) → kätt<Highlight>ä</Highlight> (part)
            → käde<Highlight>ssä</Highlight> (iness)
          </ExampleText>
          <ExampleText>
            <Highlight>Type 3 Noun:</Highlight> vesi (nom) → vede
            <Highlight>n</Highlight> (gen) → vett<Highlight>ä</Highlight> (part)
            → vede<Highlight>ssä</Highlight> (iness)
          </ExampleText>
          <ExampleText>
            <Highlight>Type 1 Verb:</Highlight> puhua → puhu
            <Highlight>n</Highlight> (pres) → puhu<Highlight>isi</Highlight>{" "}
            (cond) → puhu<Highlight>ttu</Highlight> (past part)
          </ExampleText>
          <ExampleText>
            <Highlight>Type 2 Verb:</Highlight> syödä → syö
            <Highlight>n</Highlight> (pres) → syö<Highlight>isi</Highlight>{" "}
            (cond) → syö<Highlight>ty</Highlight> (past part)
          </ExampleText>
          <ExampleText>
            <Highlight>Type 3 Verb:</Highlight> tulla → tule
            <Highlight>n</Highlight> (pres) → tuli<Highlight>si</Highlight>{" "}
            (cond) → tull<Highlight>ut</Highlight> (past part)
          </ExampleText>
        </ExampleBox>
        ...
        <ExampleBox>
          <ExampleText>
            1. &quot;kirja&quot; - Type 1 Noun (ends in -a)
          </ExampleText>
          <ExampleText>
            2. &quot;mennä &quot; - Type 3 Verb (ends in -nnä)
          </ExampleText>
          <ExampleText>
            3. &quot;vesi &quot; - Type 3 Noun (ends in -si, stem changes)
          </ExampleText>
          <ExampleText>
            4. &quot;tehdä &quot; - Type 2 Verb (ends in -dä)
          </ExampleText>
          <ExampleText>
            5. &quot;nainen &quot; - Type 2 Noun (ends in -nen)
          </ExampleText>
          <ExampleText>
            6. &quot;lukea &quot; - Type 1 Verb (ends in -ea)
          </ExampleText>
          <ExampleText>
            7. &quot;auto &quot; - Type 4 Noun (loanword, follows Type 1
            patterns)
          </ExampleText>
          <ExampleText>
            8. &quot;tavata &quot; - Type 4 Verb (ends in -ata)
          </ExampleText>
        </ExampleBox>
        ...
        <SummaryBox>
          ...
          <ExplanationContent>
            ✅ Verbs are categorized into 6 types based on their inflection
            patterns
          </ExplanationContent>
          <ExplanationContent>
            ✅ Recognizing word types helps predict case endings and
            conjugations
          </ExplanationContent>
          <ExplanationContent>
          ...
          <ExplanationContent>
            ✅ With practice, you&apos;ll develop an intuition for Finnish word
            patterns
          </ExplanationContent>
        </SummaryBox>
        ...
        <FunFactBox>
          <span>🌟 Pro Tip: </span>
          When learning new vocabulary, always learn the word&apos;s type along
          with its meaning. This will save you time later when you need to use
          the word in different cases or tenses!
        </FunFactBox>
      </ExplanationSection>
    </Container>
  );
