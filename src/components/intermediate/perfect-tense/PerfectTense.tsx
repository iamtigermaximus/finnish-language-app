...
const verbTypes: VerbType[] = [
  {
    ...
    pattern:
      "Form the past participle by removing the final vowel and adding -nut/nyt. Then combine with the appropriate form of olla.",
    negativePattern:
      "Use the negative form of olla + the past participle (nut/nyt for singular, neet for plural).",
    conjugation: {
      puhua: {
        positive: [
          "Minä olen puhunut",
      ...
      lukea: {
        ...
        negative: [
          ...
          "Sinä et ole lukenut",
          "Hän ei ole lukenut",
          "Me emme ole lukeneet",
          "Te ette ole lukeneet",
          "He eivät ole lukeneet",
        ],
      },
    },
  },
  {
    ...
    pattern:
      "Form the past participle by removing -da/-dä and adding -nut/nyt. Then combine with the appropriate form of olla.",
    negativePattern:
      "Use the negative form of olla + the past participle (nut/nyt for singular, neet for plural).",
    conjugation: {
      syödä: {
  ...
  },
  {
    ...
    pattern:
      "Form the past participle by removing the last two letters and adding -lut/lyt or -nut/nyt. Then combine with the appropriate form of olla.",
    negativePattern:
      "Use the negative form of olla + the past participle (lut/lyt or nut/nyt for singular, leet or neet for plural).",
    conjugation: {
      tulla: {
        positive: [
          "Minä olen tullut",
  ...
  },
  {
    ...
    pattern:
      "Form the past participle by removing -ta/-tä and adding -nnut/nnyt. Then combine with the appropriate form of olla.",
    negativePattern:
      "Use the negative form of olla + the past participle (nnut/nnyt for singular, nneet for plural).",
    conjugation: {
      tavata: {
        positive: [
          "Minä olen tavannut",
      ...
      haluta: {
        ...
        negative: [
          "Minä en ole halunnut",
          "Sinä et ole halunnut",
          "Hän ei ole halunnut",
          "Me emme ole halunneet",
          "Te ette ole halunneet",
    ...
    conjugation: {
      tarvita: {
        positive: [
          ...
          "Sinä olet tarvinnut",
          "Hän on tarvinnut",
          "Me olemme tarvinneet",
          "Te olette tarvinneet",
          "He ovat tarvinneet",
        ],
        negative: [
          "Minä en ole tarvinnut",
          "Sinä et ole tarvinnut",
          "Hän ei ole tarvinnut",
          "Me emme ole tarvinneet",
          "Te ette ole tarvinneet",
      ...
      valita: {
        ...
        negative: [
          "Minä en ole valinnut",
          "Sinä et ole valinnut",
          "Hän ei ole valinnut",
          "Me emme ole valinneet",
          "Te ette ole valinneet",
    ...
    conjugation: {
      paeta: {
        ...
        negative: [
          ...
          "Sinä et ole paennut",
          "Hän ei ole paennut",
          "Me emme ole pakenneet",
          "Te ette ole pakenneet",
          "He eivät ole pakenneet",
        ],
      },
      vanheta: {
        positive: [
          ...
          "Sinä olet vanhennut",
          "Hän on vanhennut",
          "Me olemme vanhenneet",
          "Te olette vanhenneet",
          "He ovat vanhenneet",
        ],
        negative: [
          "Minä en ole vanhennut",
          "Sinä et ole vanhennut",
          "Hän ei ole vanhennut",
          "Me emme ole vanhenneet",
          "Te ette ole vanhenneet",
          "He eivät ole vanhenneet",
        ],
      },
    },
  },
...
const PerfectTense = () => {
  ...
  return (
    <Container>
      <Title>Finnish Verb Types - Perfect Tense</Title>
      ...
      >
        <p>
          The perfect tense in Finnish is formed with the auxiliary verb
          &ldquo;olla&ldquo; (to be) in the present tense combined with the past
          participle (nut/nyt/neet) of the main verb. It describes completed
      ...
      >
        <h3>Remember This!</h3>
        <p>
          The perfect tense is formed with the present tense of
          &ldquo;olla&ldquo; (to be) + the past participle. The participle
          agrees with the subject in number (singular/plural).
        </p>
        <p style={{ marginTop: "10px", fontWeight: "bold" }}>
          For the negative perfect tense, use the negative form of
          &ldquo;olla&ldquo; (en ole, et ole, ei ole, etc.) + the appropriate
          participle form (nut/nyt for singular, neet for plural).
        </p>
      </div>
    </Container>
  );
