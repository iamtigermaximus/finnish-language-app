...
const grammarRules: GrammarRule[] = [
  {
    ...
    examples: [
      ...
      },
      {
        ...
        formal: "hän",
        english: "he/she",
        usage: "Casual third person",
      },
      {
        informal: "ne",
        formal: "he",
        english: "they",
        usage: "Casual third person plural",
      },
    ],
  },
  {
    ...
    examples: [
      {
        ...
        formal: "olet",
        english: "are",
        usage: "Casual 'to be' with 'sä'",
      },
      {
        informal: "tiiä",
        formal: "tiedä",
        english: "know",
        usage: "Casual spoken contraction",
      },
      {
        informal: "mennään",
        formal: "mennään",
      ...
      },
      {
        ...
        formal: "katso",
        english: "look",
        usage: "Casual command",
      },
      {
        informal: "ei mee",
        formal: "ei mene",
        english: "it won't",
        usage: "Informal negation",
      },
      {
        informal: "tulee",
        formal: "tulee",
        english: "comes",
        usage: "Informal spoken",
      },
      {
        informal: "tui",
        formal: "tule",
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        informal: "ei oo",
        formal: "ei ole",
        english: "isn't / isn't it",
        usage: "Informal 'to be' negation",
      },
      {
        informal: "ei nää",
        formal: "ei näe",
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        ...
        usage: "Same as formal, casual tone",
      },
      {
        informal: "kato!",
        formal: "katso!",
      ...
      },
      {
        ...
        formal: "hei",
        english: "hi / bye",
        usage: "Casual greeting/farewell",
      },
      {
        informal: "terve!",
        formal: "hei!",
        english: "hi!",
        usage: "Friendly greeting",
      },
    ],
  },
  {
    ...
    examples: [
      {
        ...
        usage: "Negation contraction",
      },
      {
        informal: "mä meen",
        formal: "minä menen",
        english: "I'm going",
        usage: "Pronoun + verb contraction",
      },
      {
        informal: "sä tuut?",
        formal: "sinä tulet?",
        english: "are you coming?",
        usage: "Casual spoken question",
      },
      {
        informal: "jääks",
        formal: "jääkö?",
        english: "shall we stay?",
        usage: "Casual contraction of auxiliary verbs",
      },
      {
        informal: "menoo",
        formal: "menee",
        english: "goes",
        usage: "Informal elongated vowels",
      },
      {
        informal: "mikä meininki?",
        formal: "mikä on tilanne?",
        english: "what's up?",
        usage: "Casual inquiry",
      },
    ],
  },
];
  ...
  return (
    <Container>
      <Header>
        ...
        <Subtitle>
          Learn common informal forms, spoken contractions, and casual
          expressions
        </Subtitle>
      </Header>
      <PracticeContainer>
            ...
            {rule.examples.map((example, idx) => (
              <ExampleCard key={idx}>
                <CardRow>
                  ...
                  <CardValue>
                    {example.informal} ({example.english})
                  </CardValue>
                </CardRow>
                <CardRow>
